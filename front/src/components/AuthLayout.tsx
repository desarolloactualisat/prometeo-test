              ...
              <div className="p-6">
                {userImage ? (
                  <div className="flex justify-between">
                    <div className="flex flex-col gap-4 mb-6">
                      <Link to="/" className="block">
                        <img className="h-12 block dark:hidden" src={logoDark} />
                        <img className="h-12 hidden dark:block" src={logoLight} />
                      </Link>
                  ...
                  <Link to="/" className="block mb-8">
                    <img className="h-16 block dark:hidden" src={logoDark} alt="" />
                    <img className="h-16 hidden dark:block" src={logoLight} alt="" />
                  </Link>
                )}
